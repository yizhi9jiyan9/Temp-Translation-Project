...
#set other settings
scoreboard players set buildRounds SettingsLob 1
...
scoreboard players set itemSetup SettingsLob 3
scoreboard players set itemTmr SettingsLob 2
...
scoreboard players set rounds SettingsLob 2
scoreboard players set spawnStyle SettingsLob 1
scoreboard players set lives SettingsLob 2
scoreboard players set teamNum SettingsLob 4
function lobby:settings/display/main

#items
data modify storage item main set value [9,10,11,12,15]
...
scoreboard players set mainLength ItemList 5

data modify storage item second set value [4,6,9,10,11,12,14,18]
...
scoreboard players set secondLength ItemList 8

data modify storage item armor set value [4]
...
scoreboard players set armorLength ItemList 1
execute positioned 470 140 463 run function item_chest:load



#tellraw
tellraw @a[distance=..6] ["",{"text":"[Preset] ","color":"gray"},{"text":"Loaded","color":"yellow"},{"text":" 'Duel TNT'","color":"red"},{"text":" preset","color":"yellow"},{"text":"\n   "},{"text":"> Check out the original game here ","color":"yellow","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/project/duel-tnt-realms-published-1-12-and-1-11/"},"hoverEvent":{"action":"show_text","contents":"Click to go to the Duel TNT website"}},{"text":"[click]","color":"gold","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/project/duel-tnt-realms-published-1-12-and-1-11/"},"hoverEvent":{"action":"show_text","contents":"Click to go to the Duel TNT website"}},{"text":" ","color":"yellow","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/project/duel-tnt-realms-published-1-12-and-1-11/"}}]
