#set gamemode
function lobby:settings/gamemodes/dm_ffa

execute if entity @e[tag=sett,tag=dm_team] run function lobby:settings/gamemodes/team_switch/dm/to_ffa
...
scoreboard players set itemBoxSetup SettingsLob 3
...
#tellraw
tellraw @a[distance=..6] ["",{"text":"[Preset] ","color":"gray"},{"text":"Loaded","color":"yellow"},{"text":" 'Simple Deathmatch'","color":"gray"},{"text":" preset","color":"yellow"}]
