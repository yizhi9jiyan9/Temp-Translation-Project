...
scoreboard players set itemBoxSetup SettingsLob 4
...
#items
data modify storage item main set value [1,2,3,4,5,6,7,8,10,14,18]
...
data modify storage item second set value [1,2,3,4,5,8,9,10,15,16,17]
...
scoreboard players set secondLength ItemList 11

data modify storage item armor set value [14]
...
#tellraw
tellraw @a[distance=..6] ["",{"text":"[Preset] ","color":"gray"},{"text":"Loaded","color":"yellow"},{"text":" 'Dragon Wars'","color":"dark_purple"},{"text":" preset","color":"yellow"},{"text":"\n   "},{"text":"> Check out the original game here ","color":"yellow","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/project/dragon-wars-4897362/"},"hoverEvent":{"action":"show_text","contents":"Click to go to the Dragon Wars website"}},{"text":"[click]","color":"gold","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/project/dragon-wars-4897362/"},"hoverEvent":{"action":"show_text","contents":"Click to go to the Dragon Wars website"}},{"text":" ","color":"yellow","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/project/dragon-wars-4897362/"}}]
