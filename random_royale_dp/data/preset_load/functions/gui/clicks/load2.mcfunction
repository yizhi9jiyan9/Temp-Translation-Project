...
scoreboard players set respawnTime SettingsLob 1
...
#tellraw
tellraw @a[distance=..6] ["",{"text":"[Preset] ","color":"gray"},{"text":"Loaded","color":"yellow"},{"text":" 'Small but Mighty'","color":"white"},{"text":" preset","color":"yellow"}]
