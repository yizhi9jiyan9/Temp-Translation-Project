...
#scoreboard 
execute if score #removed item_chest matches 1 run scoreboard players set m5 ItemList 0
execute if score #removed item_chest matches 0 run scoreboard players set m5 ItemList 1